...
const AIAnalytics: React.FC<AIAnalyticsProps> = ({ receipts, isLimitReached, incrementUsage }) => {
    ...
    const examplePrompts = [
        "Is my report ready for submission?",
        "How much did I spend on travel?",
        "List all my client entertainment expenses.",
    ...
    return (
        <div className="p-6 bg-white rounded-2xl shadow-lg border border-slate-200 animate-fade-in-up">
            <div className="flex items-center gap-3">
                 ...
                 <div>
                    <h2 className="text-xl font-bold text-slate-800">AI Expense Analyst</h2>
                    <p className="text-sm text-slate-500 mt-1">Ask Alex about your spending.</p>
                </div>
            </div>
                ...
                <div className="mt-6">
                    ...
                    {analysis && !isLoading && (
                        <div className="mt-6 p-4 bg-slate-50 border border-slate-200 rounded-lg space-y-2">
                            <h3 className="font-semibold text-slate-700 mb-2">Alex says:</h3>
