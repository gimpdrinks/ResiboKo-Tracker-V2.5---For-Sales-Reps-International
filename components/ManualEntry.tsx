...
const ManualEntry: React.FC<ManualEntryProps> = ({ initialData, onClose, onSave }) => {
  ...
  const [rate, setRate] = useState('0.67'); // Default rate for USD/mile
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="my-4 p-4 bg-slate-50 rounded-lg border border-slate-200">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label htmlFor="distance" className="block text-xs font-medium text-slate-500 mb-1">Distance (miles)</label>
                ...
                <div>
                  <label htmlFor="rate" className="block text-xs font-medium text-slate-500 mb-1">Rate ($/mile)</label>
